...
import { Bus, Users, MapPin, Clock, Play } from 'lucide-react';
                  ...
                  <>
                    ...
                    <div className="p-4 border rounded-lg">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <Badge variant={todaySchedule.afternoonDrop?.status === 'completed' ? 'default' : 'secondary'}>{todaySchedule.afternoonDrop?.status || 'scheduled'}</Badge>
                      </div>
                    </div>
                  </>
                ) : (
